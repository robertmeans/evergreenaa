...
function validate_new($row, $nf1, $fn1, $nf2, $fn2, $nf3, $fn3, $nf4, $fn4) {
  ...
  // begin file errors whenever there is any other error message
  // this is so the message will be in order - at the bottom but above
  // any potential Notes error.
  ...
  } else if ((!has_length($row['group_name'], ['min' => 1, 'max' => 50])) && ((isset($fn1) && $fn1 != '') || (isset($fn2) && $fn2 != '') || (isset($fn3) && $fn3 != '') || (isset($fn4) && $fn4 != ''))) {
    if (isset($fn1) && $fn1 != '') {
      $errors['name_link1'] = "Restore file selection in position 1.";
    }
    if (isset($fn2) && $fn2 != '') {
...
// need a separate validation function because of file uploads
  ...
  // begin file error messages if there are any other error messages.
  // these get a special place down here so they will show up in order
  if (is_blank($row['group_name']) && ((isset($fn1) && $fn1 != '') || (isset($fn2) && $fn2 != '') || (isset($fn3) && $fn3 != '') || (isset($fn4) && $fn4 != ''))) {
    if (isset($fn1) && $fn1 != '') {
      $errors['name_link1'] = "Restore file selection in position 1.";
    }
