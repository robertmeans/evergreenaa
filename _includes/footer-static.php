...
<script type="text/javascript" src="js/jquery.backstretch.landing-pgs.js?<?php echo time(); ?>"></script>
<!-- ^^ landing-pgs is any page that does not render msgs or preload needed to conceal them -->
