<nav>
	<ul>
		...
		switch ($layout_context) {
			...
			case 'thor-active' 			:	?><li><a class="logout" href="<?= WWW_ROOT ?>">Home</a></li><?php 	break;
			case 'suspend-user-odin' 		:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/odin.php' ?>">Home</a></li><?php 		break;
			case 'suspend-user-thor' 		:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 		break;
			case 'email-everyone' 	:	?><li><a class="logout" href="<?= WWW_ROOT ?>">Home</a></li><?php 					break;
			case 'reinstate-user-odin' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/odin.php' ?>">Home</a></li><?php 	break;
			case 'reinstate-user-thor' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			case 'host-management-odin' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/odin.php' ?>">Home</a></li><?php 	break;
			case 'host-management-thor' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			...
			case 'manage-edit-thor' 			:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			...
			case 'manage-edit-rev-thor' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			...
			case 'manage-delete-thor' 		:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
		...
		switch ($layout_context) {
			...
			case 'thor-manage' 			:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			...
			case 'manage-new-thor' 	:	?><li><a class="logout odin" href="<?= WWW_ROOT . '/thor.php' ?>">Home</a></li><?php 	break;
			...
			case 'thor-active' 			:	?><li><a class="logout odin" href="manage.php">Manage</a></li><?php 	break;
			...
			case 'reinstate-user-odin' 	:	?><li><a class="logout odin" href="manage.php">Manage</a></li><?php 	break;
			case 'reinstate-user-thor' 	:	?><li><a class="logout odin" href="manage.php">Manage</a></li><?php 	break;
