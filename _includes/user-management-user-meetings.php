	...
	<div class="manage-glance-wrap">
		<div class="manage-glance user-glance">
			...
			<div class="glance-mtg glance-mtg-type">
				...
				<a class="manage-edit" href="host-management.php?id=<?= h(u($rowz['id_mtg'])); ?>"><div class="tooltip"><span class="tooltiptext">Transfer Meeting</span><i class="fas fa-people-arrows"></i></div></a>
