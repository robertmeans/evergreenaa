...
function apply_neg_offset_to_meetings($results, $tz) {
  $utc = 'UTC';
	...
	foreach($results as $k=>$v) {
	  ...
	  $ct = new DateTime($v['meet_time'], $from_tz_obj);
	  ...
	  if ($v['sun'] == '1') {
	    ...
	    // $v['meet_time'] = $csun->format('Hi'); // new time
	  ...
	  if ($v['mon'] == '1') {
	    ...
	    // $v['meet_time'] = $cmon->format('Hi'); // new time
	  ...
	  if ($v['tue'] == '1') {
	    ...
	    // $v['meet_time'] = $ctue->format('Hi'); // new time
	    // $results[$k]['meet_time'] = $v['meet_time'];
	  ...
	  if ($v['wed'] == '1') {
	    ...
	    // $v['meet_time'] = $cwed->format('Hi'); // new time
	    // $results[$k]['meet_time'] = $v['meet_time'];
	  ...
	  if ($v['thu'] == '1') {
	    ...
	    // $v['meet_time'] = $cthu->format('Hi'); // new time
	    // $results[$k]['meet_time'] = $v['meet_time'];
	  ...
	  if ($v['fri'] == '1') {
	    ...
	    // $v['meet_time'] = $cfri->format('Hi'); // new time
	    // $results[$k]['meet_time'] = $v['meet_time'];
	  ...
	  if ($v['sat'] == '1') {
	    ...
	    // $v['meet_time'] = $csat->format('Hi'); // new time
	    // $results[$k]['meet_time'] = $v['meet_time'];
