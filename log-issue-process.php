...
if (is_post_request()) {
	...
	if($message) {
	    ...
	    try { 
		  ...
		  // } else {
			 //  $signal = 'bad';
			 //  $msg = 'We appear to have encountered a problem with your problem. Please try again and if it happens again report it in the footer of this website. Sorry for the inconvenience.';	
		  // }
